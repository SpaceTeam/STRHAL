...
#define LID_ADC_CHANNEL_SAMPLINGTIME LL_ADC_SAMPLINGTIME_247CYCLES_5
...
#define LID_ADC_COMMONCLOCK LL_ADC_CLOCK_SYNC_PCLK_DIV4
//DMA
#define LID_ADC_DMA DMA1
#define LID_ADC_DMA_CHANNEL LL_DMA_CHANNEL_3 // the 3 DMA channels start here
#define LID_ADC_DMA_PRIORITY LL_DMA_PRIORITY_VERYHIGH
