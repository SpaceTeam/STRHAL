...
{ .port = GPIOA, .pin = LL_GPIO_PIN_5, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI1, }, [STRHAL_SPI_SPI1_SCK_PB3] =
{ .port = GPIOB, .pin = LL_GPIO_PIN_3, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI1, },

[STRHAL_SPI_SPI2_SCK_PB13] =
{ .port = GPIOB, .pin = LL_GPIO_PIN_13, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI2, }, [STRHAL_SPI_SPI2_SCK_PF1] =
{ .port = GPIOF, .pin = LL_GPIO_PIN_1, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI2, }, [STRHAL_SPI_SPI2_SCK_PF9] =
{ .port = GPIOF, .pin = LL_GPIO_PIN_9, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI2, }, [STRHAL_SPI_SPI2_SCK_PF10] =
{ .port = GPIOF, .pin = LL_GPIO_PIN_10, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI2, },
...
{ .port = GPIOA, .pin = LL_GPIO_PIN_6, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI1, }, [STRHAL_SPI_SPI1_MISO_PB4] =
{ .port = GPIOB, .pin = LL_GPIO_PIN_4, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI1, },

[STRHAL_SPI_SPI2_MISO_PA10] =
{ .port = GPIOA, .pin = LL_GPIO_PIN_10, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI2, }, [STRHAL_SPI_SPI2_MISO_PB14] =
{ .port = GPIOB, .pin = LL_GPIO_PIN_14, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI2, },
...
{ .port = GPIOA, .pin = LL_GPIO_PIN_7, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI1, }, [STRHAL_SPI_SPI1_MOSI_PB5] =
{ .port = GPIOB, .pin = LL_GPIO_PIN_5, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI1, },

[STRHAL_SPI_SPI2_MOSI_PA11] =
{ .port = GPIOA, .pin = LL_GPIO_PIN_11, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI2, }, [STRHAL_SPI_SPI2_MOSI_PB15] =
{ .port = GPIOB, .pin = LL_GPIO_PIN_15, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI2, },
...
{ .port = GPIOA, .pin = LL_GPIO_PIN_4, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI1, }, [STRHAL_SPI_SPI1_NSS_PA15] =
{ .port = GPIOA, .pin = LL_GPIO_PIN_15, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI1, },

[STRHAL_SPI_SPI2_NSS_PB12] =
{ .port = GPIOB, .pin = LL_GPIO_PIN_12, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI2, }, [STRHAL_SPI_SPI2_NSS_PD15] =
{ .port = GPIOD, .pin = LL_GPIO_PIN_15, .afn = LL_GPIO_AF_6, .spi = STRHAL_SPI_SPI2, }, [STRHAL_SPI_SPI2_NSS_PF0] =
{ .port = GPIOF, .pin = LL_GPIO_PIN_0, .afn = LL_GPIO_AF_5, .spi = STRHAL_SPI_SPI2, },
