...
const static STRHAL_ADC_AnalogPin_t gpioMapping[5][STRHAL_ADC_CHANNEL_LAST] =
{
{

//1
		[STRHAL_ADC_CHANNEL_10] = { .port = GPIOF, .pin = LL_GPIO_PIN_0, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_10 },
		...
		[STRHAL_ADC_CHANNEL_1] = { .port = GPIOA, .pin = LL_GPIO_PIN_0, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_1 },
		...
		[STRHAL_ADC_CHANNEL_15] = { .port = GPIOB, .pin = LL_GPIO_PIN_0, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_15 },
...
//2
		[STRHAL_ADC_CHANNEL_10] = { .port = GPIOF, .pin = LL_GPIO_PIN_1, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_10 },
		[STRHAL_ADC_CHANNEL_6] = { .port = GPIOC, .pin = LL_GPIO_PIN_0, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_6 },
		[STRHAL_ADC_CHANNEL_7] = { .port = GPIOC, .pin = LL_GPIO_PIN_1, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_7 },
		[STRHAL_ADC_CHANNEL_8] = { .port = GPIOC, .pin = LL_GPIO_PIN_2, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_8 },
		[STRHAL_ADC_CHANNEL_9] = { .port = GPIOC, .pin = LL_GPIO_PIN_3, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_9 },
		...
		[STRHAL_ADC_CHANNEL_13] = { .port = GPIOA, .pin = LL_GPIO_PIN_5, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_13 },

		[STRHAL_ADC_CHANNEL_3] = { .port = GPIOA, .pin = LL_GPIO_PIN_6, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_3 },
		[STRHAL_ADC_CHANNEL_4] = { .port = GPIOA, .pin = LL_GPIO_PIN_7, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_4 },
		...
		[STRHAL_ADC_CHANNEL_12] = { .port = GPIOB, .pin = LL_GPIO_PIN_2, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_12 },
		...
		[STRHAL_ADC_CHANNEL_12] = { .port = GPIOB, .pin = LL_GPIO_PIN_0, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_12 },
		[STRHAL_ADC_CHANNEL_1] = { .port = GPIOB, .pin = LL_GPIO_PIN_1, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_1 },
		...
		[STRHAL_ADC_CHANNEL_14] = { .port = GPIOE, .pin = LL_GPIO_PIN_10, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_14 },
		[STRHAL_ADC_CHANNEL_15] = { .port = GPIOE, .pin = LL_GPIO_PIN_11, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_15 },
		[STRHAL_ADC_CHANNEL_16] = { .port = GPIOE, .pin = LL_GPIO_PIN_12, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_16 },

		[STRHAL_ADC_CHANNEL_3] = { .port = GPIOE, .pin = LL_GPIO_PIN_13, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_3 },
...
//4
		...
		[STRHAL_ADC_CHANNEL_1] = { .port = GPIOE, .pin = LL_GPIO_PIN_14, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_1 },
		[STRHAL_ADC_CHANNEL_2] = { .port = GPIOE, .pin = LL_GPIO_PIN_15, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_2 },

		[STRHAL_ADC_CHANNEL_3] = { .port = GPIOB, .pin = LL_GPIO_PIN_12, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_3 },

		[STRHAL_ADC_CHANNEL_4] = { .port = GPIOB, .pin = LL_GPIO_PIN_14, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_4 },

		[STRHAL_ADC_CHANNEL_5] = { .port = GPIOB, .pin = LL_GPIO_PIN_15, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_5 },

		[STRHAL_ADC_CHANNEL_12] = { .port = GPIOD, .pin = LL_GPIO_PIN_8, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_12 },
		[STRHAL_ADC_CHANNEL_13] = { .port = GPIOD, .pin = LL_GPIO_PIN_9, .type = STRHAL_ADC_INTYPE_REGULAR, .channel = LL_ADC_CHANNEL_13 },
