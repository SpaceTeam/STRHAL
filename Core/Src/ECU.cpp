...
ECU::ECU(uint32_t node_id, uint32_t fw_version) :
	...
	servo_1(10, LID_TIM_TIM8, LID_TIM_TIM8_CH2_PB8, {ADC1, LID_ADC_CHANNEL_2}, {ADC1, LID_ADC_CHANNEL_3}, {GPIOC, 14, LID_GPIO_TYPE_OPP}),
	servo_2(11, LID_TIM_TIM1, LID_TIM_TIM1_CH3N_PB9, {ADC1, LID_ADC_CHANNEL_4}, {ADC2, LID_ADC_CHANNEL_17}, {GPIOC, 15, LID_GPIO_TYPE_OPP}),
