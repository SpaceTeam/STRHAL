...
ECU::ECU(uint32_t node_id, uint32_t fw_version, uint32_t refresh_divider) :
	...
	press_0(0, {ADC2, LID_ADC_CHANNEL_15}, 1),
	press_1(1, {ADC3, LID_ADC_CHANNEL_5}, 1),
	press_2(2, {ADC1, LID_ADC_CHANNEL_14}, 1),
	press_3(3, {ADC3, LID_ADC_CHANNEL_7}, 1),
	press_4(4, {ADC1, LID_ADC_CHANNEL_5}, 1),
	press_5(5, {ADC1, LID_ADC_CHANNEL_11}, 1),
	temp_0(6, {ADC1, LID_ADC_CHANNEL_6}, 1),
	temp_1(7, {ADC1, LID_ADC_CHANNEL_7}, 1),
	temp_2(8, {ADC1, LID_ADC_CHANNEL_8}, 1),
	servo_0(9, 0, LID_TIM_TIM4, LID_TIM_TIM4_CH2_PB7, {ADC1, LID_ADC_CHANNEL_9}, {ADC1, LID_ADC_CHANNEL_1}, {GPIOC, 13, LID_GPIO_TYPE_OPP}, 1),
	servo_1(10, 1, LID_TIM_TIM4, LID_TIM_TIM4_CH3_PB8, {ADC1, LID_ADC_CHANNEL_2}, {ADC1, LID_ADC_CHANNEL_3}, {GPIOC, 14, LID_GPIO_TYPE_OPP}, 1),
	servo_2(11, 2, LID_TIM_TIM4, LID_TIM_TIM4_CH4_PB9, {ADC1, LID_ADC_CHANNEL_4}, {ADC2, LID_ADC_CHANNEL_17}, {GPIOC, 15, LID_GPIO_TYPE_OPP}, 1),
	pyro0_cont(13, {GPIOA, 10, LID_GPIO_TYPE_IHZ}, 1),
	pyro1_cont(15, {GPIOA, 8, LID_GPIO_TYPE_IHZ}, 1),
	pyro2_cont(17, {GPIOC, 8, LID_GPIO_TYPE_IHZ}, 1),
	pyro_igniter0(12, {ADC3, LID_ADC_CHANNEL_2}, {GPIOA, 9, LID_GPIO_TYPE_OPP}, pyro0_cont, 1),
	pyro_igniter1(14, {ADC3, LID_ADC_CHANNEL_6}, {GPIOC, 9, LID_GPIO_TYPE_OPP}, pyro1_cont, 1),
	pyro_igniter2(16, {ADC3, LID_ADC_CHANNEL_4}, {GPIOC, 7, LID_GPIO_TYPE_OPP}, pyro2_cont, 1),
	solenoid_0(18, {ADC2, LID_ADC_CHANNEL_16}, {GPIOD, 9, LID_GPIO_TYPE_OPP}, 1),
	solenoid_1(19, {ADC2, LID_ADC_CHANNEL_18}, {GPIOD, 8, LID_GPIO_TYPE_OPP}, 1),
	pressure_control(20, press_3, solenoid_0, 1),
	imu_0(21, LID_SPI_SPI3, {LID_SPI_SPI3_SCK_PC10, LID_SPI_SPI3_MISO_PC11, LID_SPI_SPI3_MOSI_PC12, LID_SPI_SPI3_NSS_PA15, LID_SPI_MODE_MASTER, LID_SPI_CPOL_CPHASE_HH, 0x7, 0}, 1),
