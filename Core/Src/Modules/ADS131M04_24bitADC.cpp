...
ADS131M04_24bitADC::ADS131M04_24bitADC(const STRHAL_SPI_Id_t &spiId, const STRHAL_SPI_Config_t &spiConf, const STRHAL_GPIO_t &dataReadyPin) :
		spiId(spiId), spiConf(spiConf), dataReadyPin(dataReadyPin)
{
}

int ADS131M04_24bitADC::init()
{
...
bool ADS131M04_24bitADC::measurementReady()
{
	return (measDataNum == 0) ? false : true;
}

int ADS131M04_24bitADC::read()
{
...
void ADS131M04_24bitADC::getMeasurement(int32_t &measurement)
{
