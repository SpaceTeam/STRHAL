...
IOBv3::IOBv3(uint32_t node_id, uint32_t fw_version, uint32_t refresh_divider) :
		...
		channel3(3,{ ADC2, STRHAL_ADC_CHANNEL_13 },		{ GPIOA, 10, STRHAL_GPIO_TYPE_OPP }, STRHAL_ADC_INTYPE_OPAMP, 1),
		channel4(4,{ ADC3, STRHAL_ADC_CHANNEL_7 },		{ GPIOC,  6, STRHAL_GPIO_TYPE_OPP }, STRHAL_ADC_INTYPE_OPAMP, 1),
		channel5(5,{ ADC3, STRHAL_ADC_CHANNEL_4 },		{ GPIOA,  6, STRHAL_GPIO_TYPE_OPP }, STRHAL_ADC_INTYPE_OPAMP, 1),
		channel6(6,{ ADC1, STRHAL_ADC_CHANNEL_1 },		{ GPIOD,  2, STRHAL_GPIO_TYPE_OPP }, STRHAL_ADC_INTYPE_OPAMP, 1),
		channel7(7,{ ADC1, STRHAL_ADC_CHANNEL_8 },		{ GPIOC,  0, STRHAL_GPIO_TYPE_OPP }, STRHAL_ADC_INTYPE_OPAMP, 1),
		channel8(8,{ ADC2, STRHAL_ADC_CHANNEL_5 },		{ GPIOA,  4, STRHAL_GPIO_TYPE_OPP }, STRHAL_ADC_INTYPE_OPAMP, 1),
